...
const resolveImage = (img?: string | null): string => {
  if (!img || !img.trim()) return "/images/no-image.png";
          ...
          <section className={styles.orderDetailCard}>
            <div className={styles.orderDetailSummary}>
              ...
              <div className={styles.orderSummaryItem}>
                ...
                <span className={styles.orderSummaryLabel}>
                  {order?.address || "Ünvan qeyd olunmayıb"}
                </span>
              </div>
              <div className={styles.orderSummaryItem}>
                <span className={styles.orderSummaryValue}>
              ...
              <div className={styles.orderSummaryItem}>
                ...
                <span className={styles.orderSummaryLabel}>
                  {formatAmount(order?.totalPrice || 0)} / Pulsuz
                </span>
              </div>
            </div>
            ...
            <div className={styles.orderProducts}>
              {isLoading ? (
                <p className={styles.ordersState}>
                  Sifariş detalları yüklənir...
                </p>
              ) : null}
                    ...
                    <div key={product.id} className={styles.productRow}>
                      <div className={styles.productInfo}>
                        <div className={styles.productImage}>
                          ...
                          <img
                            src={resolveImage(product.imgUrl)}
                            alt={product.title}
                            width={40}
                            height={40}
                          />
